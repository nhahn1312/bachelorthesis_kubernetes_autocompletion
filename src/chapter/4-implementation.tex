...
Anschließend wird jeweils die Menge von \textit{Token}, die zu einem \ac{yaml}-\textit{Document} zugehörig sind, zusammengefasst.
...
Der Ausschnitt des Quellcodes ist auf Listing~\ref{lst:get-completions-schemaless-completion-service} zu sehen. Die Methode wird aus der Methode ``doComplete'' heraus aufgerufen.
