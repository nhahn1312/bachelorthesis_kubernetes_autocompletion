...
Das vorherige Kapitel hat, dass bestehende Implementierungen nicht alle Herausforderungen beim Schreiben von Kubernetes \textit{Manifest}-Dateien erfüllen
