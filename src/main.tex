...
\newcommand{\thesistitle}{Kubernetes Konfigurationsdateien}
\newcommand{\thesissubtitle}{Herausforderungen, Probleme und mögliche Lösungen}
...
\newcommand{\thesisdate}{\AdvanceDate[+1]\today}
